...
class SpinnerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val adaptadorSpinnerUsuarios = ArrayAdapter<Usuario>(this, android.R.layout.simple_spinner_item, arregloUsuarios)

        adaptadorSpinnerUsuarios.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item)
